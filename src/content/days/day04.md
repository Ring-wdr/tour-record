...
stops:
  - id: zenkov
    ...
    coords: [76.9532, 43.2588]
    time: "11:05"
    elevation: 755
    kind: culture
    camera: { zoom: 16, pitch: 60, bearing: 45 }
    note: 1907년 목조로 지어져 대지진을 버틴 성당. 안으로 들어가면 금빛 이콘이 벽을 가득 채우고 있다.
    photos:
      - { src: /photos/day04/20260914_112152.jpg, alt: 성당 내부 }
  ...
  - id: central-museum
    name: 중앙 국립 박물관
    nameEn: Central State Museum of Kazakhstan
    coords: [76.9507, 43.2358]
    time: "14:25"
    elevation: 854
    kind: culture
  ...
  - id: steak
    ...
    photos:
      ...
      - { src: /photos/day04/20260914_180005.jpg, alt: 카르파초 }
---
